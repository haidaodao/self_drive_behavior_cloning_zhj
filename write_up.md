...
The objective of this project is to clone human driving behavior using a Deep Neural Networks and convolutional neural networks. First, we navigate our car inside the simulator to collect training data, and, Second, we create a trainning model.py to train the neural networks. And last, we use this model to drive the car autonomously around the track.
                           ![training_img](./images/track.gif) 
...
<p align="center">
 <img src="./images/pipe.png" width="550">
</p>
...
## Results 
In the beginning,I used a dataset generated by myself.However, the model built using that dataset was not good enough to autonomously navigate the car in the simulator. Then, I used the dataset published by the Udacity.  The model developed using that dataset (with the help of augmented data) works well on the track. I recorded the video while the car navigating with the modle,and you can see that in the folder of video.
...
* Train a model in real road conditions. 
* Experiment with other possible data augmentation techniques.
* It is very important to select an appropriate model. How to improve the accuracy of the model and reduce the dependence on high-cost hardware is a subject worthy of further study.
